#!/bin/bash
#$ -N ablation_placebo_combine
#$ -t 1-10
#$ -cwd
#$ -j y
#$ -o ablation/logs/placebo_combine_$TASK_ID.log
#$ -q long
...
#   qsub ablation/conversion_guides/submit_placebo_combine.sh
#
...
SRC_DIR="${REPO_ROOT}/ablation/conversion_guides/placebo/${REPLICATE}/all.R"
OUT_DIR="${REPO_ROOT}/ablation/conversion_guides/placebo/${REPLICATE}_kernsmooth"
