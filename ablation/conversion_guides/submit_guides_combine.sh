#!/bin/bash
#$ -N ablation_guides_combine
#$ -t 1-10
#$ -cwd
#$ -j y
#$ -o ablation/logs/guides_combine_$TASK_ID.log
#$ -q long
...
#   qsub ablation/conversion_guides/submit_guides_combine.sh
#
...
SRC_DIR="${REPO_ROOT}/ablation/conversion_guides/guides/${REPLICATE}/all.R"
OUT_DIR="${REPO_ROOT}/ablation/conversion_guides/guides/${REPLICATE}_kernsmooth"
