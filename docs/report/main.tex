...
\texttt{r2py\_kernsmooth/} &
  Python package under development; contains \texttt{r2py\_kernsmooth/\_\_init\_\_.py}, \texttt{meson.build}, \texttt{pyproject.toml}, Fortran sources in \texttt{src/}, and \texttt{tests/test.py}. \\
...
The build system uses \texttt{meson-python} as the build backend, declared in \texttt{r2py\_kernsmooth/pyproject.toml}:
...
The complete build definition resides in \texttt{r2py\_kernsmooth/meson.build}.
...
The rewritten \texttt{r2py\_kernsmooth/r2py\_kernsmooth/\_\_init\_\_.py} is 1,052 lines and satisfies the following properties:
